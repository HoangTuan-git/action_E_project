...
process.env.JWT_SECRET = 'test_secret_key_for_ci'; // Dùng một secret giả cho test
process.env.QUEUE_NAME = 'products'; // Tên queue của product
process.env.RABBITMQ_QUEUE = 'orders'; // Tên queue của order
